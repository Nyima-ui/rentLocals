  ...
  return (
    <div className="grow space-y-3">
      ...
      <div className="flex items-center justify-between max-w-lg">
        ...
        <Input type="date" id="start-date" className="max-w-[320px]" />
      </div>
      <div className="flex items-center justify-between max-w-lg">
        <label htmlFor="end-date" className="text-nowrap">
          End date:
        </label>
        <Input type="date" id="end-date" className="max-w-[320px]" />
      </div>
      <p className="mt-10 max-w-xl">
        <span className="text-lg block">About the item:</span>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto
        consectetur nostrum adipisci molestias eligendi facilis ratione tenetur
        doloribus iusto deleniti?
      </p>
      <div>
        <h2 className="text-center text-3xl font-medium opacity-80 mt-6">
          $27.50
        </h2>
        <p className="text-center text-gray-500">Price for 1 day</p>
      </div>
      <Button className="mx-auto block mt-5">Request booking</Button>
      <div className="mt-10">
        <p className="text-center text-lg">Price for all periods:</p>
...
export function OwnerInfo() {
  return (
    <Card className="flex flex-row items-start max-md:flex-col mt-10">
